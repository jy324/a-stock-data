...
<p align="center">
  <b>A 股全栈数据工具包 — 10 层架构 · 44 个端点 · 15 个数据源 · 零鉴权</b>
</p>
...
```text
git+https://github.com/jy324/a-stock-data.git@a6203349cf00c6e29056c9be1cc7d103bd1fba3c#egg=astock-data
```
